    ...
    cell: ({ row }) => (
      <div
        className={cn(
          ...
          row.original.type === "income" && "bg-incomeColor text-gray-600",
          row.original.type === "expense" && "bg-expenseColor text-gray-600"
        )}
      >
        {row.original.type === "income" ? "수입" : "지출"}
      </div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <p className="text-md rounded-lg bg-gray-400/5 p-2 font-medium text-center">
